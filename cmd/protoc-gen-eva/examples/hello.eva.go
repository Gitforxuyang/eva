...
func GetServerDesc() *etcd.Service {
	...
	methodPing.Req = messageMap["String"]
	methodPing.Resp = messageMap["String"]
...
type GRpcSayHelloServiceClient interface {
	...
	Ping(ctx context.Context, req *String) (resp *String, err error)
}
...
func (m *grpcSayHelloServiceClient) Ping(ctx context.Context, req *String) (resp *String, err error) {
